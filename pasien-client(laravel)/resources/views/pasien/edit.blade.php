  ...
  <div class="container">
    <div class="row justify-content-md-center">
      <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
        ...
        <p class="text-secondary mb-5 text-center">Edit Data Pasien</p>
    ...
    <div class="row justify-content-lg-center">
      <div class="col-12 col-lg-9">
        <div class="bg-white border rounded shadow-sm overflow-hidden">
          <form action="{{ url('updatepasien', $query['id_pasien']) }}" method="post" accept-charset="utf-8">
          @csrf
          @method('put')
	            <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
              	<div class="col-12">
                	<label for="nama" class="form-label">Nama Pasien <span class="text-danger">*</span></label>
                	<input type="text" class="form-control" id="nama" name="nama" value="{{ isset($query['nama'])?$query['nama']:old('nama') }}">
              	</div>        
                    ...
                    <input type="date" class="form-control" id="tgl_lahir" name="tgl_lahir"  value="{{ isset($query['tgl_lahir'])?$query['tgl_lahir']:old('tgl_lahir') }}">
                  </div>
                </div>
                <div class="col-12 col-md-6">
                  ...
                  <div class="input-group">
                      <span class="input-group-text">
                        ...
                        <input type="text" class="form-control" id="jk" name="jk" value="{{ isset($query['jk'])?$query['jk']:old('jk') }}">
                  </div>
                </div>
                <div class="col-12">
                	<label for="nama" class="form-label">No. Rekam Medis <span class="text-danger">*</span></label>
                	<input type="text" class="form-control" id="no_rm" name="no_rm" value="{{ isset($query['no_rm'])?$query['no_rm']:old('no_rm') }}">
              	</div>  
                <div class="col-12">
                	<label for="nama" class="form-label">Riwayat Penyakit <span class="text-danger">*</span></label>
                	<input type="text" class="form-control" id="rp" name="rp" value="{{ isset($query['rp'])?$query['rp']:old('rp') }}">
              	</div> 
                <div class="col-12">
                  <div class="d-grid">
